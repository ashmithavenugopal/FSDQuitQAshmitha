...
export class ManageProductsSellerComponent {
  ...
  submitProductForm(): void {
    const productData: AddProductRequest ={
      product: {
        productId: this.isEditing ? this.productForm.get('productId')!.value : 0,
        productName: this.productForm.get('productName')!.value,
        sellerId: this.productForm.get('sellerId')!.value, // Use the sellerId obtained from token
        description: this.productForm.get('description')!.value,
        price: this.productForm.get('price')!.value,
        stockQuantity: this.productForm.get('stockQuantity')!.value,
        imageUrl: this.productForm.get('imageUrl')!.value,
        dateAdded: this.isEditing ? new Date().toISOString() : this.productForm.get('dateAdded')!.value,
